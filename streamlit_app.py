...
2. **Профиль** — radar Top-5, lab overlay, economics lead candidate
3. **Лаборатория / OPEX / ОПР / Хемоинформатика** — deliverables по ТЗ
4. **Отчёты** — генерация 6 .docx + ZIP
5. **Для заказчика** — позиционирование эксперта
"""
)
